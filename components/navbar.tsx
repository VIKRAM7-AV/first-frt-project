        ...
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 py-3.5 sm:py-4 flex items-center justify-between gap-4">
          ...
          >
            ...
            <div className="relative w-10 h-10 sm:w-11 sm:h-11 flex-shrink-0">
              ...
              >
                {/* Globe / Produce circle gradient background */}
                <circle
                  cx="24"
                  cy="25"
                  r="18"
                ...
                <circle
                  ...
                  strokeWidth="1.5"
                />
                {/* Fresh Apple & Orange & Leaf inside emblem */}
                <circle cx="20" cy="27" r="10" fill="#65a30d" />
                <circle cx="27" cy="29" r="8" fill="#eab308" />
                <circle cx="24" cy="33" r="5" fill="#dc2626" />
                {/* Top Leaf Accent */}
                <path
                  d="M24 10C24 10 28 8 32 11C32 15 28 17 24 15C24 15 25 12 24 10Z"
                  fill="#15803d"
                />
                <path
                  d="M24 15C22 13 18 12 16 15C15 18 19 20 23 18"
                  stroke="#166534"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                />
            ...
            <div className="flex flex-col">
              <span className="text-xl sm:text-2xl font-bold tracking-tight text-[#14532d] leading-none">
                Freshway
              </span>
              <span className="text-[10px] sm:text-[11px] font-bold tracking-[0.24em] text-[#16a34a] uppercase leading-none mt-1">
                Wholesale
              </span>
            </div>
          </Link>
